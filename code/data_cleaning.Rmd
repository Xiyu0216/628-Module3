...
data<-data[-1]
c_name<-data[1,] # Get colume names
...
business_FL<-subset(data,data[5]=="FL")
...
Chinese_restaurant<-Chinese_restaurant[1:30] #Variable selection

# Replace missing values
Chinese_restaurant$attributes.RestaurantsPriceRange2[is.na(Chinese_restaurant$attributes.RestaurantsPriceRange2)]<-0
Chinese_restaurant[is.na(Chinese_restaurant)]<-"False"

write.csv(Chinese_restaurant,"Chinese_restaurant.csv",row.names= FALSE)
...
Korean_restaurant<-Korean_restaurant[1:30] #Variable selection
Korean_restaurant$attributes.RestaurantsPriceRange2[is.na(Korean_restaurant$attributes.RestaurantsPriceRange2)]<-0
Korean_restaurant[is.na(Korean_restaurant)]<-"False"
write.csv(Korean_restaurant,"Korean_restaurant.csv",row.names= FALSE)
