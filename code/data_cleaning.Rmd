...
C_r<-Chinese_restaurant[1:30] #Variable selection

# Replace missing values
C_r$attributes.RestaurantsPriceRange2[is.na(C_r$attributes.RestaurantsPriceRange2)]<-0
C_r[is.na(C_r)]<-"False"
#Combine the selected variables with other attributes
Chinese_restaurant<-cbind(C_r,Chinese_restaurant[31:50])
...
K_r<-Korean_restaurant[1:30] #Variable selection

# Replace missing values
K_r$attributes.RestaurantsPriceRange2[is.na(K_r$attributes.RestaurantsPriceRange2)]<-0
K_r[is.na(K_r)]<-"False"
#Combine the selected variables with other attributes
Korean_restaurant<-cbind(K_r,Korean_restaurant[31:50])
